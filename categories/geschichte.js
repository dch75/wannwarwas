DATA.geschichte = [
  ...
  {event:"Cheops-Pyramide erbaut",year:-2560,icon:"🔺",diff:"leicht",
  ...
  {event:"Anschläge vom 11. September",year:2001,icon:"🏙️",diff:"leicht",
  ...
  {event:"Russische Revolution",year:1917,icon:"☭",diff:"leicht",
  ...
  {event:"Gründung Israels",year:1948,icon:"✡️",diff:"leicht",
  ...
  {event:"Mandela wird Präsident",year:1994,icon:"✊",diff:"leicht",
  ...
  {event:"Schlacht bei Marathon",year:-490,icon:"⚔️",diff:"normal",
  ...
  {event:"Mongolisches Reich gegründet",year:1206,icon:"🏹",diff:"normal",
  ...
  {event:"Kennedy-Attentat",year:1963,icon:"🔫",diff:"normal",
   info:"Am 22. November 1963 wurde US-Präsident John F. Kennedy in Dallas erschossen."},

  {event:"Ende des Vietnamkriegs",year:1975,icon:"🌿",diff:"normal",
   info:"1975 fiel Saigon – die USA zogen ab und Nordvietnam vereinte das Land."},

  {event:"Zerfall der Sowjetunion",year:1991,icon:"☭",diff:"normal",
  ...
  {event:"Schlacht bei Salamis",year:-480,icon:"⚓",diff:"schwer",
   info:"480 v. Chr. vernichtete Athen die persische Flotte bei Salamis – Griechenland blieb frei."},

  {event:"Tod des Archimedes",year:-212,icon:"🔵",diff:"schwer",
